                ...
                <div className="ActivityDetails">
                    ...
                    <div className="Column Gap-16">
                        <div className="OnlyFocus Row Gap-8"> {/* Active 상태에서는 로드하지 않음 */}
                            <Card CardSimple="True" Title="IIDX" Paragraph="2대 (T1)" AccentText="" Accent={ NoAccent } Background={ PreferGame }/>
                            <Card CardSimple="True" Title="SDVX" Paragraph="8대 (L3)" AccentText="" Accent={ NoAccent } Background={ PreferGame }/>
                            <Card CardSimple="True" Title="마이마이" Paragraph="4대" AccentText="" Accent={ NoAccent } Background={ PreferGame }/>
                        </div>
                    ...
                    <div className="Column Gap-16">
                        ...
                        <div className="Column Group-Card">
                            <Card Title="IIDX" Paragraph="라이트 1000원, 프리미엄 2000원" Paragraph2="3,5번 기체 방송 가능" AccentText="1대" Accent={ DynamicWater }/>
                            <hr/>
